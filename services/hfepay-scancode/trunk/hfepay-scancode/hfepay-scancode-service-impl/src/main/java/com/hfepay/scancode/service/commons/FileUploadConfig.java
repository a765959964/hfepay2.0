package com.hfepay.scancode.service.commons;
...
public class FileUploadConfig {
	...
	private String agentQrPath;

	public String getAgentQrPath() {
		return agentQrPath;
	}

	public void setAgentQrPath(String agentQrPath) {
		this.agentQrPath = agentQrPath;
	}
