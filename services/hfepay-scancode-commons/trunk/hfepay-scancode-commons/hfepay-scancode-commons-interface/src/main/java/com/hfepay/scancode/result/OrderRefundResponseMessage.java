 ...
 *支付返回报文体
 */
public class OrderRefundResponseMessage extends ResponseMessage<OrderRefundResponseMessage.Body> {
	private static final long serialVersionUID = 238032038699187311L;
	private Body body;
	
	public OrderRefundResponseMessage(){
...
//		}
		...
		public String toString() {
			return "Body [cashierNo=" + cashierNo + ", tradeNo=" + tradeNo + ", orderStatus=" + orderStatus
					+ ", userOrderNo=" + userOrderNo /*+ ", payPlatOrderNo=" + payPlatOrderNo*/ + "]";
		}
