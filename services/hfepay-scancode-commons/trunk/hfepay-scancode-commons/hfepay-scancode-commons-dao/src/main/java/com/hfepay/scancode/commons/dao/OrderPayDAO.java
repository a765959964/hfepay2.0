...
public interface OrderPayDAO extends EntityDAO<OrderPay, String> {
	 ...
	 * @return: BigDecimal
	 */
	List<OrderPay> getTotalMoney(String date,String merchantNo,String identityFlag);
	 ...
	 * @return
	 */
	BigDecimal getTotalInMoney(String date, String identityNo, String identityFlag);
