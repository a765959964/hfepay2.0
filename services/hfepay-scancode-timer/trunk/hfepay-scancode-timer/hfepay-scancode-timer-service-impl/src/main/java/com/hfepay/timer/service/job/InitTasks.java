...
//		timerService.addCronJob("WithdrawlsQueryJobClear", "JOBGROUP", WithdrawlsQueryJobClear.class, "0 56 23 * * ?");
		...
		timerService.addCronJob("ReconciliationJob", "JOBGROUP", ReconciliationJob.class, "0 0 23 * * ?");//交易对账23点开始执行

		timerService.addCronJob("LiquidationJob", "JOBGROUP", LiquidationFeeJob.class, "0 0 0 * * ?");//清算手续费0点开始执行
