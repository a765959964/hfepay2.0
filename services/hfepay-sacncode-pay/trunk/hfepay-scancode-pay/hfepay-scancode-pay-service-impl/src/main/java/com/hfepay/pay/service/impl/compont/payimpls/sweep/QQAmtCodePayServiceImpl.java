 ...
 *
 */
@Service("QQAmtCodePayService")
public class QQAmtCodePayServiceImpl extends BaseAmtCodePayService implements PayOperatorService{
	...
	public String strategyCode() {
		return PayStrategyEnum.QQ_AMTCODE_PAY.getStrategyCode();
	}
