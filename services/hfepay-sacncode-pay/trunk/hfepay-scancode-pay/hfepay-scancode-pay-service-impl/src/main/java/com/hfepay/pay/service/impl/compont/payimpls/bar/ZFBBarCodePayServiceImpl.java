 ...
 *
 */
@Service("ZFBBarCodePayService")
public class ZFBBarCodePayServiceImpl extends BaseBarCodePayService implements PayOperatorService{
	...
	public String strategyCode() {
		return PayStrategyEnum.ZFB_BARCODE_PAY.getStrategyCode();
	}
