 ...
 *
 */
@Service("ZFBMerchantCodePayService")
public class ZFBMerchantCodePayServiceImpl extends BaseMerchantCodePayService implements PayOperatorService{
	...
	public String strategyCode() {
		return PayStrategyEnum.ZFB_MERCHANTCODE_PAY.getStrategyCode();
	}
