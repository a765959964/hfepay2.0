 ...
 *
 */
@Service("QQMerchantCodePayService")
public class QQMerchantCodePayServiceImpl extends BaseMerchantCodePayService implements PayOperatorService{
	...
	public String strategyCode() {
		return PayStrategyEnum.QQ_MERCHANTCODE_PAY.getStrategyCode();
	}
