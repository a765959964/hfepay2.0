 ...
 *
 */
@Service("wechatBarCodePayService")
public class WechatBarCodePayServiceImpl extends BaseBarCodePayService implements PayOperatorService{
	...
	public String strategyCode() {
		return PayStrategyEnum.WX_BARCODE_PAY.getStrategyCode();
	}
