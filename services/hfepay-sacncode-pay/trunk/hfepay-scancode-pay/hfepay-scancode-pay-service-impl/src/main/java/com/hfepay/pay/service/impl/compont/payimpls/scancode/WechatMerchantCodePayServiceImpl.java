 ...
 *
 */
@Service("wechatMerchantCodePayService")
public class WechatMerchantCodePayServiceImpl extends BaseMerchantCodePayService implements PayOperatorService{
	@Autowired
	...
	public String strategyCode() {
		return PayStrategyEnum.WX_MERCHANTCODE_PAY.getStrategyCode();
	}
