...
public class Encrypter {
     ...
     * AES加密算法
     **/
    private final static String AES_CIPHER_ALGORITHM = "AES/ECB/PKCS5Padding";
    /**
     * RSA签名算法
     **/
    private final static String RSA_SIGNALGORITHM = "SHA1WithRSA";
    /**
     * RSA加密算法
     **/
    private final static String RSA_CIPHER_ALGORITHM = "RSA/ECB/PKCS1Padding";
    /****
     * keyLength 密钥bit长度
     **/
     ...
     **/
    private final static int RESEVE_SIZE = 11;
    /**
     * 私钥对象
     ***/
    ...
    private final static String RSA_NAME = "RSA";
	...
	public Encrypter(final String key, final boolean encrypt) {
        try {
            if (!encrypt) {
                ...
                KeyFactory keyFactoryPrivate = KeyFactory.getInstance(RSA_NAME);
                ...
                KeyFactory keyFactoryPublic = KeyFactory.getInstance(RSA_NAME);
