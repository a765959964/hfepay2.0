								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<div class="col-md-8">
											...
											<button type="button" class="btn btn-default" onClick="javascript:window.location.href='${path}/adminManage/message/0'">新增</a></button>
										</div>
									</div>
								</div>
								<!--/span-->
...
<script src="${path}/resources/scripts/admin/message/list.js?rnd=${version}" type="text/javascript"></script>
