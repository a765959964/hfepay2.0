...
<!-- 							<h3 class="form-section">查询</h3> -->
							...
							<div class="row">
								...
								<div class="col-md-3">
									<div class="form-group">
										<label class="control-label col-md-4">所属机构编号</label>
										<div class="col-md-8">
											<input type="text" class="form-control" id="parentNo" name="parentNo">
										</div>
									</div>
								</div>
								<!--/span-->
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-md-10">
											...
											<button type="button" class="btn btn-default" onClick="javascript:window.location.href='${path}/adminManage/agentbase/0'">新增</a></button>
										</div>
									</div>
								</div>
								<!--/span-->
...
<script src="${path}/resources/scripts/admin/agentbase/list.js?rnd=${version}" type="text/javascript"></script>
