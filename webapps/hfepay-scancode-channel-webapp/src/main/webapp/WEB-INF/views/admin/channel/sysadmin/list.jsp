								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<div class="col-md-9">
											...
											<button type="button" class="btn btn-default" id="newUser" onClick="javascript:window.location.href='${path}/adminManage/channel/sys/admin/0'">新增账号</button>
...
<script src="${path}/resources/scripts/admin/channel/sysadmin/list.js?rnd=${version}" type="text/javascript"></script>
