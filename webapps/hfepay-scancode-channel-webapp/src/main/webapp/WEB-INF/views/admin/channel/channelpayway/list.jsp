								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<div class="col-md-9">
											...
											<button type="button" class="btn btn-default" id="newUser" onClick="javascript:window.location.href='${path}/adminManage/channelpayway/0'">新增</button>
										</div>
									</div>
								</div>
								<!--/span-->
				...
				<div class="col-md-12">
					...
					<div class="portlet box green-haze">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>渠道支付方式列表
							</div>
						</div>
...
<script src="${path}/resources/scripts/admin/channel/channelpayway/list.js?rnd=${version}" type="text/javascript"></script>
</body>
<!-- END BODY -->
</html>