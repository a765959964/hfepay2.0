					...
					<form action="save" class="form-horizontal" id="form" method="post">
						<div class="form-body">
							...
							<div class="row">
								<div class="col-lg-5 col-sm-6">
									<div class="form-group">
										<label class="control-label col-md-4 col-sm-2 col-xs-3">商户名称</label>
								...
								<c:if test="${ not empty Obj.storeNo}">
									<div class="col-lg-5 col-sm-6">
										<div class="form-group">
											<label class="control-label col-md-4 col-sm-2 col-xs-3">门店编号</label>
											<div class="col-md-4 col-xs-9 col-sm-6" style="margin-top: 7px;">
													${Obj.storeNo}
											</div>
										</div>
							...
							<div class="row">
								<div class="col-lg-5 col-sm-6">
									<div class="form-group">
										<label class="control-label col-md-4 col-sm-2 col-xs-3">门店名称</label>
							...
							<div class="row">
								<div class="col-lg-5 col-sm-6">
									<div class="form-group">
										<label class="control-label col-md-4 col-sm-2 col-xs-3">门店级别</label>
										<div class="col-md-4 col-xs-9 col-sm-6">
								...
								<div class="col-lg-5 col-sm-6">
									<div class="form-group">
										<label class="control-label col-md-4 col-sm-2 col-xs-3">服务电话</label>
										<div class="col-md-4 col-xs-9 col-sm-6">
							...
							<div class="row">
								<div class="col-lg-5 col-sm-6">
									<div class="form-group">
										<label class="control-label col-md-4 col-sm-2 col-xs-3">营业开始时间</label>
										<div class="col-md-4 col-xs-9 col-sm-6">
								...
								<div class="col-lg-5 col-sm-6">
									<div class="form-group">
										<label class="control-label col-md-4 col-sm-2 col-xs-3">营业结束时间</label>
										<div class="col-md-4 col-xs-9 col-sm-6">
							...
							<%-- <div class="row">
								<div class="col-lg-5 col-sm-6">
									<div class="form-group">
										<label class="control-label col-md-4 col-sm-2 col-xs-3">门店地址</label>
										<div class="col-md-4 col-xs-9 col-sm-6">
								...
								<div class="col-lg-5 col-sm-6">
									<div class="form-group">
										<label class="control-label col-md-4 col-sm-2 col-xs-3">商户营业执照号</label>
										<div class="col-md-4 col-xs-9 col-sm-6">
							...
							<div class="row">
								<div class="col-lg-5 col-sm-6">
									<div class="form-group">
										<label class="control-label col-md-4 col-sm-2 col-xs-3">门店介绍</label>
										<div class="col-md-4 col-xs-9 col-sm-6">
								...
								<div class="col-lg-5 col-sm-6">
									<div class="form-group">
										<label class="control-label col-md-4 col-sm-2 col-xs-3">执照名称</label>
										<div class="col-md-4 col-xs-9 col-sm-6">
							...
							<div class="row">
								<div class="col-lg-5 col-sm-6">
									<div class="form-group">
										<label class="control-label col-md-4 col-sm-2 col-xs-3">法人姓名</label>
										<div class="col-md-4 col-xs-9 col-sm-6">
								...
								<div class="col-lg-5 col-sm-6">
									<div class="form-group">
										<label class="control-label col-md-4 col-sm-2 col-xs-3">身份证号</label>
										<div class="col-md-4 col-xs-9 col-sm-6">
							...
							<div class="row">
								<div class="col-lg-5 col-sm-6">
									<div class="form-group">
										<label class="control-label col-md-4 col-sm-2 col-xs-3">身份证正面</label>
								...
								<div class="col-lg-5 col-sm-6">
									<div class="form-group">
										<label class="control-label col-md-4 col-sm-2 col-xs-3">身份证反面</label>
										<div class="col-md-4 col-sm-4">
							...
							<%-- <div class="row">
								<div class="col-lg-5 col-sm-6">
									<div class="form-group">
										<label class="control-label col-md-4 col-sm-2 col-xs-3">手持身份证</label>
										<div class="col-md-4 col-sm-4">
								...
								<div class="col-lg-5 col-sm-6">
									<div class="form-group">
										<label class="control-label col-md-4 col-sm-2 col-xs-3">营业执照图片</label>
										<div class="col-md-4 col-sm-4">
							...
							<div class="row">
								<div class="col-lg-5 col-sm-6">
									<div class="form-group">
										<label class="control-label col-md-4 col-sm-2 col-xs-3">法人门店图片</label>
										<div class="col-md-4 col-sm-4">
								...
								<div class="col-lg-5 col-sm-6">
									<div class="form-group">
										<label class="control-label col-md-4 col-sm-2 col-xs-3">相册照片</label>
										<div class="col-md-4 col-xs-9 col-sm-6">
							...
							<div class="row">
								<div class="col-lg-5 col-sm-6">
									<div class="form-group">
										<label class="control-label col-md-4 col-sm-2 col-xs-3">门店地址图片</label>
										<div class="col-md-4 col-sm-4">
								...
								<div class="col-lg-5 col-sm-6">
									<div class="form-group">
										<label class="control-label col-md-4 col-sm-2 col-xs-3">门店图片</label>
										<div class="col-md-4 col-sm-4">
							...
							<div class="row">
								...
								<div class="col-lg-5 col-sm-6">
									<div class="form-group">
										<label class="control-label col-md-4 col-sm-2 col-xs-3">店内图片</label>
										<div class="col-md-4 col-sm-4">
							...
							<div class="row">
								<div class="col-lg-5 col-sm-6">
									<div class="form-group">
										<label class="control-label col-md-4 col-sm-2 col-xs-3">备注</label>
										<div class="col-md-4 col-sm-4">
							...
							<div class="col-md-12">
								...
								<div class="col-lg-5 col-sm-6">
									<div class="form-group">
										<label class="control-label col-md-4 col-sm-2 col-xs-3"></label>
										<div class="col-md-4 col-sm-4">
