								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<div class="col-md-8">
											...
											<button type="button" class="btn btn-default" id="newUser" onClick="javascript:window.location.href='${path}/adminManage/agentadmin/0'">新增</button>
...
<script src="${path}/resources/scripts/admin/agentadmin/sysadmin/list.js?rnd=${version}" type="text/javascript"></script>
