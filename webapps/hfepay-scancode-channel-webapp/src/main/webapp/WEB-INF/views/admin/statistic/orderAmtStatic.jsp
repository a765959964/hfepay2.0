					...
					<form action="#" class="form-horizontal" id="form">
						<div class="form-body">
							<div class="row">
								...
								<c:if test="${currentUser.identityFlag=='1' }">
									<div class="col-md-3">
										<div class="form-group">
								...
								<c:if test="${currentUser.identityFlag!='3' }">
									<div class="col-md-3">
										<div class="form-group">
...
<script src="${path}/resources/scripts/admin/statistic/orderAmtStatic.js?rnd=${version}" type="text/javascript"></script>
