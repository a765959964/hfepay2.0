							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										...
										<div class="col-md-4">
											<input type="hidden" id="agentNoVal" value='${Obj.agentNo }'>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<label class="control-label col-md-6" style="color:red;display:none;" id="roleError">该渠道没有设置角色，无法新增渠道用户！</label>
										</div>
									</div>
								</div>
							<div class="row">
