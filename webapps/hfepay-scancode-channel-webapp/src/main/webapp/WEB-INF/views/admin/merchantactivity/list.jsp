								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<div class="col-md-8">
											...
											<button type="button" class="btn btn-default" onClick="javascript:window.location.href='${path}/adminManage/merchantactivity/0'">新增</a></button>
										</div>
									</div>
								</div>
								<!--/span-->
...
<script src="${path}/resources/scripts/admin/merchantactivity/list.js" type="text/javascript"></script>
