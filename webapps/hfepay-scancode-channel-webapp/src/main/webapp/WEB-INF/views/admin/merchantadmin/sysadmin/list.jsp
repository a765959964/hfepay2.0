							...
							<div class="row">
								<div class="col-md-3">
									<div class="form-group">
										<label class="control-label col-md-4">商户账号</label>
										<div class="col-md-8">
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<div class="col-md-9">
											...
											<%-- <button type="button" class="btn btn-default" id="newUser" onClick="javascript:window.location.href='${path}/adminManage/merchantadmin/0'">新增商户账号</button>
...
<script src="${path}/resources/scripts/admin/merchantadmin/sysadmin/list.js?rnd=${version}" type="text/javascript"></script>
