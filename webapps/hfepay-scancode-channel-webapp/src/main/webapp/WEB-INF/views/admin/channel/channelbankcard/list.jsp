...
<%-- <jsp:include page="../../include/menu.jsp"></jsp:include> --%>
	...
	<section id="ucenterSection">
			...
			<select id = "accountType" class="form-control" name="accountType" style="display:none">
				<option value = "">  --  请选择  --  </option>
				<option value = "0">个人</option>
				<option value = "1">公司</option>
			</select>
...
<script src="${path}/resources/scripts/admin/channel/channelbankcard/list.js?rnd=${version}" type="text/javascript"></script>
</body>
<!-- END BODY -->
</html>