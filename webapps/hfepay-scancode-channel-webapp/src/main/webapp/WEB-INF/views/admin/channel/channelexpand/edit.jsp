					...
					<form action="save" class="form-horizontal" id="form" method="post">
						<div class="form-body">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label col-md-3">二级域名编号</label>
										<div class="col-md-4">
											<input type="text" class="form-control" id="channelCode"  name = "channelCode" <c:if test="${channelPage != null}">readonly="readonly"</c:if>
											value="${Obj.channelCode}" placeholder="二级域名编号">
										</div>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label col-md-3">编码抬头</label>
										<div class="col-md-4">
											<input type="text" class="form-control ajaxCheck2" id="channelPreCode"  name = "channelPreCode" <c:if test="${channelPage != null}">readonly="readonly"</c:if>
											value="${Obj.channelPreCode}" placeholder="编码抬头">
										</div>
									</div>
								</div>
							</div>
...
<!-- 							</div> -->
							...
							<div class="row">
								<div class="col-md-9">
									<div class="form-group">
										<label class="control-label col-md-2">帮助中心</label>
										<div class="col-md-10">
							...
							<div class="row">
								<div class="col-md-9">
									<div class="form-group">
										<label class="control-label col-md-2">电子协议</label>
										<div class="col-md-10">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label col-md-3">公众号ID</label>
										<div class="col-md-4">
								...
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label col-md-3">公众号key</label>
										<div class="col-md-4">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label col-md-3">注册消息模板ID</label>
										<div class="col-md-4">
								...
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label col-md-3">支付消息模板ID</label>
										<div class="col-md-4">
											<input type="text" class="form-control"
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label col-md-3">短信用户名</label>
										<div class="col-md-4">
								...
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label col-md-3">短信密码</label>
										<div class="col-md-4">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label col-md-3">短信发送地址</label>
										<div class="col-md-4">
											<input type="text" class="form-control" 
							...
							<c:if test="${roles.size() > 0}">
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											<label class="control-label col-md-3">账户角色</label>
											<div class="col-md-8">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label col-md-3">银行卡号码</label>
										<div class="col-md-4">
											<input type="text" class="form-control"
							...
							<div class="row">								
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label col-md-3">开户行名称</label>
										<div class="col-md-4">
											<input type="text" class="form-control" readonly="readonly"
