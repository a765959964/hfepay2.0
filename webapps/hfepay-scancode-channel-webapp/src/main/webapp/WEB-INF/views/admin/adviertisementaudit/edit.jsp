					...
					<form action="save" class="form-horizontal" id="form" method="post">
						...
						<div class="form-body">
							...
							<div class="row">
								<div class="col-md-8">
									<div class="form-group">
										...
										<div class="col-md-3">
											<input type="text" class="form-control date-picker" id="beginTimeStr" name="beginTimeStr" value="<fmt:formatDate value='${Obj.startDate}' pattern='yyyy-MM-dd'/>" >
										</div>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-8">
									<div class="form-group">
										...
										<div class="col-md-3">
											<input type="text" class="form-control date-picker" id="endTimeStr" name="endTimeStr" value="<fmt:formatDate value='${Obj.endDate}' pattern='yyyy-MM-dd'/>">
										</div>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-8">
									<div class="form-group">
										<label class="control-label col-md-3">推广范围</label>
										<div class="col-md-3">
							...
							<div class="row">
								<div class="col-md-8">
									<div class="form-group">
										<label class="control-label col-md-3">广告链接</label>
										<div class="col-md-6">
							...
							<div class="row">
								<div class="col-md-8">
									<div class="form-group">
										<label class="control-label col-md-3">优先级别</label>
										<div class="col-md-3">
