								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<div class="col-md-9">
											...
											<button type="button" class="btn btn-default" onClick="javascript:window.location.href='${path}/adminManage/channelexpand/0'">新增渠道</button>
										</div>
									</div>
								</div>
								<!--/span-->
...
<script src="${path}/resources/scripts/admin/channel/channelbase/list.js?rnd=${version}" type="text/javascript"></script>
</body>
<!-- END BODY -->
</html>