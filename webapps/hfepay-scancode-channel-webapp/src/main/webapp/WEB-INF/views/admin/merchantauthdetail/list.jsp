	...
	<section id="ucenterSection">
			<%-- <div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="#">-MerchantAuthDetail-管理</a>
						<i class="fa fa-angle-right"></i>
					</li>
					<li>
						<a href="#">-MerchantAuthDetail-列表</a>
					</li>
				</ul>
			</div> --%>
			<!-- END PAGE HEADER-->
...
<script src="${path}/resources/scripts/admin/merchantauthdetail/list.js?rnd=${version}" type="text/javascript"></script>
