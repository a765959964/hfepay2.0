$(function(){
   ...
   getDate();
	...
	$(".export").click(function(){
		...
		window.open(basePath+"/adminManage/statistic/export/amtexcel?"+datajson);
	});
	...
	function getDate(){
		...
		$.ajax({
			   type: "POST",
			   url:basePath+'/adminManage/statistic/orderAmtStaticContent',
			   data:datajson,
			   dataType:"json"
			...
			var option = {
			        ...
			        legend: {
			            data:['支付宝成功金额','支付宝失败金额','微信成功金额','微信失败金额','QQ成功金额','QQ失败金额']
			        },
			        xAxis: {
