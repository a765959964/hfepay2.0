							...
							<div class="row">
								<div class="col-md-3">
									<div class="form-group">
										<label class="control-label col-md-4">通道编号</label>
										<div class="col-md-8">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-md-10">
											...
											<button type="button" class="btn btn-default" onClick="javascript:window.location.href='${path}/adminManage/platformsecretkey/0'">新增秘钥</a></button>
										</div>
									</div>
								</div>
								<!--/span-->
...
<script src="${path}/resources/scripts/admin/platformsecretkey/list.js?rnd=${version}" type="text/javascript"></script>
