...
<table class="table table-striped table-bordered" id="sample_6">
	...
	<tr>
		<td class="col-md-2 td0">账号</td><td class="col-md-4 parent_id_parse" >${item.userName}</td>
	</tr>
	<tr>
		<td class="col-md-2 td0">姓名</td><td class="col-md-4 parent_id_parse" >${item.shortName}</td>
	</tr>
	<tr>
		<td class="col-md-2 td0">账户角色</td><td class="col-md-4 parent_id_parse" >${item.roleName}</td>
	</tr>
	...
	<tr>
		<td class="col-md-2 td0">邮箱</td><td class="col-md-4 parent_id_parse" >${item.email}</td>
	</tr>
	<tr>
		<td class="col-md-2 td0">联系电话</td><td class="col-md-4 parent_id_parse" >${item.phone}</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="col-md-2 td0">创建时间</td><td class="col-md-4 date_time_parse" ><fmt:formatDate value="${item.createTime}" pattern="yyyy-MM-dd E HH:mm:ss"/></td>
	</tr>
</table>
