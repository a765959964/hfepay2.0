...
<!-- 							<h3 class="form-section">查询</h3> -->
							...
							<div class="row">
								...
								<div class="col-md-3">
									<div class="form-group">
										<label class="control-label col-md-4">第三方支付通道代码</label>
										<div class="col-md-8">
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<div class="col-md-8">
											<input type="text" class="form-control date-picker" name="queryStartDate" id="queryStartDate">
										</div>
									</div>
								</div>
								<!--/span-->
...
<script src="${path}/resources/scripts/admin/apilog/list.js?rnd=${version}" type="text/javascript"></script>
