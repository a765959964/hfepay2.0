							...
							<div class="row">
								<div class="col-md-3">
									<div class="form-group">
										<label class="control-label col-md-4">结算批次号</label>
										<div class="col-md-8">
											<input type="text" class="form-control" id="batchNo" name="batchNo" value="${batchNo}">
										</div>
									</div>
								</div>
								<div class="col-md-3">
...
<script src="${path}/resources/scripts/admin/hierarchicalsettlementtotal/list.js?rnd=${version}01" type="text/javascript"></script>
</body>
<!-- END BODY -->
</html>