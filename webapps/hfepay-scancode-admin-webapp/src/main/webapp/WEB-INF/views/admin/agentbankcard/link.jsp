				...
				<div class="col-md-12">
					<div class="portlet box green-haze">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>代理商结算账户变更记录
							</div>
						</div>
...
<script src="${path}/resources/scripts/admin/agentbankcard/link.js?rnd=${version}" type="text/javascript"></script>
