	...
	<section id="ucenterSection">
			<%-- <div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="#">-MerchantLimit-管理</a>
						<i class="fa fa-angle-right"></i>
					</li>
					<li>
						<a href="#">-MerchantLimit-列表</a>
					</li>
				</ul>
			</div> --%>
			<!-- END PAGE HEADER-->
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<div class="col-md-8">
											...
											<button type="button" class="btn btn-default" onClick="javascript:window.location.href='${path}/adminManage/merchantlimit/0'">新增</a></button>
										</div>
									</div>
								</div>
								<!--/span-->
...
<script src="${path}/resources/scripts/admin/merchantlimit/list.js?rnd=${version}" type="text/javascript"></script>
