...
<head>
<meta charset="utf-8"/>
<title>ClearingT1Err Manager</title>
...
<!-- 							<h3 class="form-section">查询</h3> -->
							...
							<div class="row">
								...
								<div class="col-md-3">
									<div class="form-group">
										<label class="control-label col-md-4">支付代码</label>
										<div class="col-md-6">
											<select id = "payCode" class="form-control" name="payCode">
												<option value = "">  --  请选择  --  </option>
												<option value = "ZFBSMZF">支付宝扫码支付</option>
												<option value = "WXSMZF">微信扫码支付</option>
												<option value = "WXGZHZF">微信公众号支付</option>
											</select>
										</div>
									</div>
								</div>
...
<%-- 											<button type="button" class="btn btn-default" id="newUser" onClick="javascript:window.location.href='${path}/adminManage/clearingt1err/0'">新增</button> --%>
										</div>
									</div>
								</div>
								<!--/span-->
...
<script src="${path}/resources/scripts/admin/clearingt1err/list.js?rnd=${version}" type="text/javascript"></script>
</body>
<!-- END BODY -->
</html>