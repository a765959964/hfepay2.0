							...
							<div class="row">
								<div class="col-md-3">
									<div class="form-group">
										<label class="control-label col-md-4">提现订单编号</label>
										<div class="col-md-8">
							...
							<div class="row">
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<div class="col-md-8">
											<select id = "resultCode" class="form-control" name="resultCode">
...
<script src="${path}/resources/scripts/admin/withdrawals/list.js?rnd=${version}" type="text/javascript"></script>
</body>
<!-- END BODY -->
</html>