...
<!-- 							<h3 class="form-section">查询</h3> -->
							...
							<div class="row">
								...
								<div class="col-md-3">
									<div class="form-group">
										<label class="control-label col-md-4">二维码名称</label>
										<div class="col-md-8">
...
<script src="${path}/resources/scripts/admin/merchantqrcode/list.js?rnd=${version}" type="text/javascript"></script>
