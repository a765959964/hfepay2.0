							...
							<div class="row">
								<div class="col-md-3">
									<div class="form-group">
										<label class="control-label col-md-4">平台支付通道代码</label>
										<div class="col-md-8">
											<input type="text" class="form-control" id="payCode" name="payCode">
										</div>
									</div>
								</div>
								<div class="col-md-3">
									<div class="form-group">
										<label class="control-label col-md-4">平台支付通道名称</label>
										<div class="col-md-8">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-md-10">
											...
											<button type="button" class="btn btn-default" id="newUser" onClick="javascript:window.location.href='${path}/adminManage/hfepaypayway/0'">新增</button>
										</div>
									</div>
								</div>
								<!--/span-->
				...
				<div class="col-md-12">
					...
					<div class="portlet box green-haze">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>支付方式设置列表
							</div>
						</div>
...
<script src="${path}/resources/scripts/admin/hfepaypayway/list.js?rnd=${version}" type="text/javascript"></script>
</body>
<!-- END BODY -->
</html>