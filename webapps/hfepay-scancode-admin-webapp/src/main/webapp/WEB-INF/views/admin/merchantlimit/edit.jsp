												...
												<div class="col-md-4">
													...
													<select  id="merchantNo" class="form-control" name="merchantNo">
														<option value="" selected = "selected">----请选择----</option>
															<c:forEach var="merchantInfo" items="${merchantList}">
																<option value = "${merchantInfo.merchantNo}">${merchantInfo.merchantName}</option>
															</c:forEach>
													</select>
													</c:if>
													<c:if test="${Obj != null}">
													<select  id="merchantNo" class="form-control" name="merchantNo">
														<option value="" selected = "selected">----请选择----</option>
															<c:forEach var="merchantInfo" items="${merchantList}">
																<option value = "${merchantInfo.merchantNo}" <c:if test="${Obj.merchantNo==merchantInfo.merchantNo}">selected="selected"</c:if>>${merchantInfo.merchantName}</option>
															</c:forEach>
													</select>
													</c:if> --%>
...
<script src="${path}/resources/scripts/admin/merchantlimit/edit.js?rnd=${version}" type="text/javascript"></script>
