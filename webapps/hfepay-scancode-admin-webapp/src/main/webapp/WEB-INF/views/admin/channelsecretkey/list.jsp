								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<div class="col-md-8">
											...
											<button type="button" class="btn btn-default" id="cancle">重置</button>
											<button type="button" class="btn btn-default" onClick="javascript:window.location.href='${path}/adminManage/channelsecretkey/0'">新增</a></button>
										</div>
									</div>
								</div>
								<!--/span-->
...
<script src="${path}/resources/scripts/admin/channelsecretkey/list.js" type="text/javascript"></script>
