									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<div class="col-md-4">
													<select class="form-control" id="storeNo" name="storeNo">
														<option value = "">  --  请选择  --  </option>
														<c:forEach var="item" items="${merchantStores}">
															<option value = "${item.storeNo}">${item.storeName}</option>
														</c:forEach>
											        </select>
											        <input type="hidden" class="form-control storeNo" value="${Obj.storeNo}">
												</div>
											</div>
										</div>
									</div>
