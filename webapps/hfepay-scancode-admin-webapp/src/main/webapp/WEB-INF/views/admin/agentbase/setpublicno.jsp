				...
				<div class="portlet-body form">
					...
					<form action="save" class="form-horizontal" id="form" method="post">
						<div class="form-body">
							...
							<input type="hidden" id="channelNo"  name = "channelNo" value="${agentBase.agentNo}">
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-md-4">
											<input type="text" class="form-control" id="agentName"  name = "agentName" 
												<c:if test="${Obj != null}">readonly="readonly"</c:if> value="${agentBase.agentName}" placeholder="渠道名称">
										</div>
									</div>
								</div>
							</div>
...
<script src="${path}/resources/scripts/admin/agentbase/setpublicno.js?rnd=${version}" type="text/javascript"></script>
