...
<html lang="en-US">
<head>
<title>扫码收款运营系统</title>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<meta charset="UTF-8">
<meta name="keywords" content="${currentChannelInfo.nickName }小二买单运营系统">
<meta name="description" content="${currentChannelInfo.nickName }小二买单运营系统">
...
<body>
	<div id="header">
		<div class="header">
		<input id="currentChannelInfoCode" value="${currentChannelInfo.channelCode }" type="hidden"/>
<%-- 			<h1 class="png_bg" style="background:url(${currentChannelInfo.indexTopImg}) 0 0 no-repeat;"></h1> --%>
			<img alt="官网" src="${path}/resources/images/logo.png" style="height:42px;position: absolute;left: 0;top: 30px;text-indent: -999em;">
		</div>
	</div>
	       ...
	       <ul>
	           <li style="background:#24dde5;">
	               <div class="banDivContent">
	                   <img style="width: 100%;height: 500px;" src="${currentChannelInfo.loginBackgroundImg }">
	               </div>
	           </li>
	       </ul>
	   </div>
...
<div id="footer" class="clear">
    <p>Copyright ©扫码收款 2016 ${currentChannelInfo.companyName }&nbsp;&nbsp;&nbsp;&nbsp;${currentChannelInfo.recordNumber }</p>
</div>
<!-- footer end -->
