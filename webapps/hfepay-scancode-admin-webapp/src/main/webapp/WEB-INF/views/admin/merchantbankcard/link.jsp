				...
				<div class="col-md-12">
					<div class="portlet box green-haze">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>商户账户信息变更记录
							</div>
						</div>
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										...
										<c:if test="${ not empty pager}"><page:page curPage="${pager.pageNo}" totalPages="${pager.totalPages}"/>
										<b class="totalCountInPage">共&nbsp;${pager.totalCount}&nbsp;条
										</c:if>
										</label>
										<div class="col-md-2">
...
<script src="${path}/resources/scripts/admin/merchantbankcard/link.js?rnd=${version}" type="text/javascript"></script>
