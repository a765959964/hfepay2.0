							...
							<div class="row">
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<div class="col-md-8">
											<select id="limitPayCode" name="limitPayCode" class="form-control">
											<option value = "">  --  请选择  --  </option>
								...
								<div class="col-md-3">
									<div class="form-group">
										<label class="control-label col-md-4">限制方式</label>
										<div class="col-md-8">
											<select id="limitMode" name="limitMode" class="form-control">
											<option value = "">  --  请选择  --  </option>
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-md-10">
											...
											<button type="button" class="btn btn-default" id="newUser" onClick="javascript:window.location.href='${path}/adminManage/organlimit/0'">新增机构限额</button>
										</div>
									</div>
								</div>
								<!--/span-->
...
<script src="${path}/resources/scripts/admin/organlimit/list.js" type="text/javascript"></script>
