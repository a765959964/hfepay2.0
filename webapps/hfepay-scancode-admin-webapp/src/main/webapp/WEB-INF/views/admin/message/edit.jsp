											...
											<div class="form-group">
												...
												<div class="col-md-4">
													...
													<c:if test="${Obj != null}">
														<select  id="userType" class="form-control" name="userType">
															<option value="" selected = "selected">----请选择----</option>
																<option value = "0" <c:if test="${Obj.userType==0}">selected="selected"</c:if>>系统</option>
																...
																<option value = "3" <c:if test="${Obj.userType==3}">selected="selected"</c:if>>渠道</option>
																<option value = "9" <c:if test="${Obj.userType==9}">selected="selected"</c:if>>不限</option>
														</select>
													</c:if>
