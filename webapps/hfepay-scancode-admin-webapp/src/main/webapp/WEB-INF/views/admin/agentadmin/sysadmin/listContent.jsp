...
<table class="table table-striped table-bordered table-hover" id="sample_6">
						  ...
						  <c:forEach var="item" items="${pager.result}"> 
						   <tr>
									...
									<td class="parent_id_parse" title="roleName">${item.agentNo}</td>
									<td class="parent_id_parse" title="roleName">${item.agentName}</td>
									...
									<td class="date_time_parse"><fmt:formatDate value="${item.createTime}" pattern="yyyy-MM-dd E HH:mm:ss"/></td>
							<td>
								...
								<a href="${path}/adminManage/agentadmin/${item.id}"><span class="label label-info">修改</span></a>
