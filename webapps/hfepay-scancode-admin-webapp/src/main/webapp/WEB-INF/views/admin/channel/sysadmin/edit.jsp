	...
	<section id="ucenterSection">
			<%-- <div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="#" onclick="javascript:history.go(-1);">渠道账号管理</a>
						<i class="fa fa-angle-right"></i>
					</li>
					<li>
...
<script src="${path}/resources/scripts/admin/channel/sysadmin/edit.js?rnd=${version}" type="text/javascript"></script>
