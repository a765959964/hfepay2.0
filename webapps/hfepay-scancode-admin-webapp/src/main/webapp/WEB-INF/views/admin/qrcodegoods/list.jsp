					...
					<form action="#" class="form-horizontal" id="form">
						<div class="form-body">
							<div class="row">
								...
								<div class="col-md-3">
									<div class="form-group">
										<label class="control-label col-md-4">是否默认</label>
										<div class="col-md-8">
...
<script src="${path}/resources/scripts/admin/qrcodegoods/list.js?rnd=${version}" type="text/javascript"></script>
