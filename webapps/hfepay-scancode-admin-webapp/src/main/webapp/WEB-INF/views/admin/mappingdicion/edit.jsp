	...
	<section id="ucenterSection">
			<%-- <div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="#" onClick="javascript:history.go(-1);">数据字典</a>
						<i class="fa fa-angle-right"></i>
					</li>
					<li>
						<c:if test="${Obj == null}"><a href="#">数据新增 </a></c:if>
						<c:if test="${Obj != null}"><a href="#">数据更新</a></c:if>
					</li>
				</ul>
			</div> --%>
			<!-- END PAGE HEADER-->
					...
					<form class="form-horizontal" id="form">
							<div class="form-body">
								...
								<div class="row">
										...
										<div class="form-group">
											...
											<div class="col-md-4">
												<input type="text" class="form-control"
													id="paraName" name="paraName" value="${Obj.paraName}"
													placeholder="参数名称">
											</div>
										</div>
									</div>
									<div class="col-md-12">
										<div class="form-group">
											<label class="control-label col-md-2">参数值</label>
											<div class="col-md-4">
												<input type="text" class="form-control"
													id="paraVal" name="paraVal" value="${Obj.paraVal}"
													placeholder="参数值">
											</div>
										</div>
									</div>
...
<script src="${path}/resources/scripts/admin/mappingdicion/edit.js?rnd=${version}" type="text/javascript"></script>
