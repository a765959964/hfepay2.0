...
<!-- 							<h3 class="form-section">查询</h3> -->
							...
							<div class="row">
								...
								<div class="col-md-3">
									<div class="form-group">
										<label class="control-label col-md-4">银行卡号码</label>
										<div class="col-md-8">
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<div class="col-md-8">
											...
											<button type="button" class="btn btn-default" onClick="javascript:window.location.href='${path}/adminManage/agentbankcard/0'">新增</a></button>
										</div>
									</div>
								</div>
								<!--/span-->
...
<script src="${path}/resources/scripts/admin/agentbankcard/list.js?rnd=${version}" type="text/javascript"></script>
