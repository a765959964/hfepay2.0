...
<head>
<meta charset="utf-8"/>
<title>MerchantBankcard Manager</title>
...
<!-- 							<h3 class="form-section">查询</h3> -->
							...
							<div class="row">
								...
								<div class="col-md-3">
									<div class="form-group">
										<label class="control-label col-md-4">账户类型</label>
										<div class="col-md-8">
								...
								<div class="col-md-12">
									<div class="form-group">
										...
										<div class="col-md-10">
											...
											<%-- <button type="button" class="btn btn-default" onClick="javascript:window.location.href='${path}/adminManage/merchantbankcard/0'">新增结算账户</a></button> --%>
										</div>
									</div>
								</div>
								<!--/span-->
...
<script src="${path}/resources/scripts/admin/merchantbankcard/list.js?rnd=${version}" type="text/javascript"></script>
