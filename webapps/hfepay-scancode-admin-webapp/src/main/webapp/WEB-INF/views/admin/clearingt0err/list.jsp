...
<head>
<meta charset="utf-8"/>
<title>ClearingT0Err Manager</title>
...
<!-- 							<h3 class="form-section">查询</h3> -->
							...
							<div class="row">
								...
								<div class="col-md-3">
									<div class="form-group">
										<label class="control-label col-md-4">处理标识</label>
										<div class="col-md-6">
											<select id = "processingStatus" class="form-control" name="processingStatus">
...
<script src="${path}/resources/scripts/admin/clearingt0err/list.js?rnd=${version}" type="text/javascript"></script>
</body>
<!-- END BODY -->
</html>