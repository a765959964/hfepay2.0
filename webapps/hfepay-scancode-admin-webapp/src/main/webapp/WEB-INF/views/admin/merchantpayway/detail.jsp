...
<table class="table table-striped table-bordered" id="sample_6">
	...
	<tr>
		<td class="col-md-2 td0">清算手续费(元)</td><td><fmt:formatNumber value="${item.rateAmount}" pattern="#0.##"/></td>
	</tr>
	<tr>
	...
	<tr>
		<td class="col-md-2 td0">操作人名称</td><td title="${item.operator}">${item.operator}</td>
	</tr>
	<tr>
