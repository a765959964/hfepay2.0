	...
	<section id="ucenterSection">
			<%-- <div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="#" onclick="javascript:history.go(-1);">商户账号管理</a>
						<i class="fa fa-angle-right"></i>
					</li>
					<li>
						<c:if test="${Obj == null}"><a href="#">商户账号新增 </a></c:if>
						<c:if test="${Obj != null}"><a href="#">商户账号更新</a></c:if>
					</li>
				</ul>
			</div> --%>
			<!-- END PAGE HEADER-->
					...
					<form action="save" class="form-horizontal" id="form" method="post">
						<div class="form-body">
										...
										<div class="form-group">
											...
											<div class="col-md-4">
												<select id = "merchantNo" class="form-control" name="merchantNo">
													<c:forEach var="obj" items="${mers}">
														<option value = "${obj.merchantNo}" id="${obj.merchantNo}" channelCode="${obj.channelNo}"  agentNo="${obj.agentNo}">${obj.shortName}</option>
													</c:forEach>
												</select>
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<label class="control-label col-md-2">商户账号*</label>
										<c:if test="${Obj == null}">
											<div class="col-md-4">
												<input type="text" class="form-control ajaxCheck" id="userName"  name = "userName" value="${Obj.userName}" placeholder="商户账号">
											</div>
										</c:if>
										<c:if test="${Obj != null}">
...
<script src="${path}/resources/scripts/admin/merchantadmin/sysadmin/edit.js?rnd=${version}" type="text/javascript"></script>
