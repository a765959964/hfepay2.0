					...
					<form action="#" class="form-horizontal" id="form">
						<div class="form-body">
							<div class="row">
								...
								<!-- <div class="col-md-3">
									<div class="form-group">
										<label class="control-label col-md-4">费率名称</label>
										<div class="col-md-8">
											<input type="text" class="form-control" id="paywayName" name="paywayName">
										</div>
									</div>
								</div> -->
								<div class="col-md-3">
									<div class="form-group">
										<label class="control-label col-md-4">费率状态</label>
										<div class="col-md-8">
								...
								<div class="col-md-3">
									<div class="form-group">
										<label class="control-label col-md-4">入网状态</label>
										<div class="col-md-8">
											<select id = "acceptStatus" class="form-control" name="acceptStatus">
												<option value = "">  --  请选择  --  </option>
...
<script src="${path}/resources/scripts/admin/merchantpayway/list.js?rnd=${version}" type="text/javascript"></script>
