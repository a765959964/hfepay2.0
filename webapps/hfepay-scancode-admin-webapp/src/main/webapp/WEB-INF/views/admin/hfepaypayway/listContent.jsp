...
<table class="table table-striped table-bordered table-hover" id="sample_6">
						  ...
						  <c:forEach var="item" items="${pager.result}"> 
						   <tr>
									...
									<td><fmt:formatNumber value="${item.rate}" pattern="#0.#####"/></td>
							...
							<td>
								...
								<a href="${path}/adminManage/hfepaypayway/${item.id}"><span class="label label-info">修改</span></a>
