...
<table class="table table-striped table-bordered table-hover" id="sample_6">
						  ...
						  <c:forEach var="item" items="${pager.result}"> 
						   <tr>
									...
									<td class="parent_id_parse" title="limitPayCode">${item.paraName}</td>
							...
							<td>
								...
								<a href="${path}/adminManage/merchantlimit/${item.id}"><span class="label label-info">修改</span></a>
